...
OBJECTS = ./main.o ./UART_multiData/UART_multiData.o 
...
CC_SYMBOLS = -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -DARM_MATH_CM3 -DTARGET_CORTEX_M -DTARGET_LPC176X -DTARGET_NXP -DTARGET_MBED_LPC1768 -DTARGET_LPC1768 -D__CORTEX_M3 -DTARGET_M3 -DMBED_BUILD_TIMESTAMP=1453860056.41 -D__MBED__=1 
